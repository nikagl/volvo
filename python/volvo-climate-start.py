...
try:
    url = "https://api.volvocars.com/connected-vehicle/v2/vehicles/" + config["volvo_vin"] + '/commands/climatization-start'
    print("URL: {}".format(url))
    vehicles = requests.post(
        url,
        headers= {
            "Content-Type": "application/vnd.volvocars.api.connected-vehicle.climatizationstart.v2+json",
