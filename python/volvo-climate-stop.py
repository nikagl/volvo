...
try:
    url = "https://api.volvocars.com/connected-vehicle/v2/vehicles/" + config["volvo_vin"] + '/commands/climatization-stop'
    print("URL: {}".format(url))
    vehicles = requests.post(
        url,
        headers= {
            "Content-Type": "application/vnd.volvocars.api.connected-vehicle.climatizationstop.v2+json",
