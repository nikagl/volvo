...
try:
    url = "https://api.volvocars.com/connected-vehicle/v1/vehicles/" + config["volvo_vin"] + '/commands/navi-point-of-interest'
    print("URL: {}".format(url))
    vehicles = requests.post(
        url,
        headers= {
            "Content-Type": "application/vnd.volvocars.api.connected-vehicle.navipointofinterest.v1+json",
